...
def imdb_json_api(logger_instance, **kwargs):
    ...
    index_dict.update({
        ...
        'imdb_running_time_in_minutes': running_time_in_minutes, 'imdb_genre_list': genres_list,
        'imdb_director_list': credits_director_list,
        'imdb_writer_list': credits_writer_list, 'imdb_cast_list': credits_cast_list,
        'imdb_language_list': spoken_languages_list,
        'imdb_country_list': country_origins_list,
        'imdb_character_list': credits_character_list
    })
