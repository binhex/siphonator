...
class QueueManagement(object):
    ...
    def delete_stalled_torrents(self):
        ...
        if not torrent_clients_instance.qbittorrent_check_global_speed():
            return False

        # get list of torrents added by siphonator (category set)
        qbittorrent_identify_torrents_with_category_dict = torrent_clients_instance.qbittorrent_identify_torrents_with_category()
        ...
        qbittorrent_identify_torrents_for_deletion_dict = torrent_clients_instance.qbittorrent_identify_torrents_for_deletion(qbittorrent_identify_torrents_with_category_dict)
        ...
        torrent_clients_instance.qbittorrent_delete_torrents(qbittorrent_identify_torrents_for_deletion_dict)
