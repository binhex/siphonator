...
class FilterMovies(object):
    ...
    def __init__(self, logger_instance, init_dict, result_dict, config_dict, index_site_dict, library_path_walk):
    ...
    def filter_index_override_title(self):
        ...
        if not index_title_and_year_compare:
